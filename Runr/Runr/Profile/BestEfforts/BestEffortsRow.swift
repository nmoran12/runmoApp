...
struct BestEffortRow_Previews: PreviewProvider {
    static var previews: some View {
        BestEffortRow(effort: BestEffortsViewModel.BestEffort(distance: "5K", time: 1500, date: Date()))
